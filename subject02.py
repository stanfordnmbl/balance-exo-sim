...
def add_to_study(study):    
    ...
    # Trial to use
    gait_events = dict()
    gait_events['right_strikes'] = [0.76, 1.92, 3.08, 4.25]
    gait_events['left_toeoffs'] = [0.93, 2.10, 3.26] 
    gait_events['left_strikes'] = [1.34, 2.51, 3.66] 
    gait_events['right_toeoffs'] = [1.54, 2.70, 3.84]
